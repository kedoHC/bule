...
<div id="contenedor-hamburguesas">
	<div class="container">
		<div class="col-xs-3">
			<h2 id="bule-h0" class="nombre-producto">DeepBule <span>$48.50</span></h2>
			<h2 id="bule-h1" class="nombre-producto">MasterMeet <span>$48.50</span></h2>
			<h2 id="bule-h2" class="nombre-producto">La Brava <span>$50.00</span></h2>
			<h2 id="bule-h3" class="nombre-producto">BuleBuilding <span>$38.50</span></h2>
			<h2 id="bule-h4" class="nombre-producto">GreenBurguer <span>$40.50</span></h2>
			<h2 id="bule-h5" class="nombre-producto">BuleX <span>$60.00</span></h2>
		</div>
		<div id="ingredientes" class="col-xs-3">
			...
			<a id="producto0" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto1" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto2" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto3" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto4" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto5" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
		</div>
		<div class="col-xs-6">
...
<div id="contenedor-hotdogs">
	<div class="container">
		<div class="col-xs-3">
			<h2 id="bule-hd0" class="nombre-producto">DeepBuleHotDog <span>$48.50</span></h2>
			<h2 id="bule-hd1" class="nombre-producto">MasterHD <span>$48.50</span></h2>
			<h2 id="bule-hd2" class="nombre-producto">El Barrio <span>$50.00</span></h2>
			<h2 id="bule-hd3" class="nombre-producto">The Bridge <span>$38.50</span></h2>
			<h2 id="bule-hd4" class="nombre-producto">HotGreen <span>$40.50</span></h2>
			<h2 id="bule-hd5" class="nombre-producto">HotDogLeon <span>$60.00</span></h2>
		</div>
		<div id="ingredientes" class="col-xs-3">
			...
			<a id="producto0hd" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto1hd" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto2hd" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto3hd" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto4hd" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto5hd" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
		</div>
		<div class="col-xs-6">
...
<div id="contenedor-bebidas">
	<div class="container">
		<div class="col-xs-3">
			<h2 id="bule-b0" class="nombre-producto">AguasBule <span>$48.50</span></h2>
			<h2 id="bule-b1" class="nombre-producto">RefrescoDeRaiz <span>$48.50</span></h2>
			<h2 id="bule-b2" class="nombre-producto">Refresco <span>$50.00</span></h2>
			<h2 id="bule-b3" class="nombre-producto">Jugos <span>$38.50</span></h2>
			<h2 id="bule-b4" class="nombre-producto">CervezaAlemana <span>$40.50</span></h2>
			<h2 id="bule-b5" class="nombre-producto">CervezaNacional <span>$60.00</span></h2>
		</div>
		<div id="ingredientes" class="col-xs-3">
			...
			<a id="producto0b" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto1b" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto2b" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto3b" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto4b" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto5b" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
		</div>
		<div class="col-xs-6">
...
<div id="contenedor-varios">
	<div class="container">
		<div class="col-xs-3">
			<h2 id="bule-v0" class="nombre-producto">PapasBuleCheese <span>$48.50</span></h2>
			<h2 id="bule-v1" class="nombre-producto">PapasEnGajos <span>$48.50</span></h2>
			<h2 id="bule-v2" class="nombre-producto">PapasFrancesas <span>$50.00</span></h2>
			<h2 id="bule-v3" class="nombre-producto">GuacamoleBule <span>$38.50</span></h2>
			<h2 id="bule-v4" class="nombre-producto">NachosLaFiera <span>$40.50</span></h2>
			<h2 id="bule-v5" class="nombre-producto">EnsaladaHouse <span>$60.00</span></h2>
		</div>
		<div id="ingredientes" class="col-xs-3">
			...
			<a id="producto0v" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto1v" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto2v" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto3v" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto4v" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
			...
			<a id="producto5v" class="agregarcarrito" href="agregarcarrito.php"><button class="center-block">Agregar a mi orden</button></a>
		</div>
		<div class="col-xs-6">
